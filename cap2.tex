...
\begin{figure}[h]
    \centering
    \includesvg[width=0.8\textwidth]{pico-pins.svg}
...
Con todo configurado y conectado se logra comprobar que la información de X-Plane está siendo procesada por el autopiloto, observando que el movimiento del horizonte artificial en Mission Planner corresponde al de la inclinación de la aeronave.