...
Para terminar esta implementación de la comunicación, se configura el puerto de telemetría donde está conectado el Raspberry como interfaz para sistema de estimación de actitud externo, como se observa en \cref{fig:missionplanner-params-serial} seleccionando la opción ``AHRS''.
